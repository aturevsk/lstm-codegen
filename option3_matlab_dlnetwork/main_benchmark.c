/*
 * Option 3 benchmark — importNetworkFromPyTorch -> dlnetwork -> MATLAB Coder (R2026a)
...
int main(void)
{
    ...
    for (i = 0; i < N_WARMUP; i++)
        lstm_infer_opt3((const float *)shared_test_input, predictions);
    ...
    printf("Option 3: MATLAB Coder (importNetworkFromPyTorch->dlnetwork, R2026a)\n");
